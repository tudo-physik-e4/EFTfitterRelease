...
// ---------------------------------------------------------
BCMVCombination_EFT::BCMVCombination_EFT()
  : BCModel("BCMVCombination_EFT")
  , fDetCovariance(0)
  , fNObservables(0)
...
// ---------------------------------------------------------
void BCMVCombination_EFT::AddObservable(std::string name, double min, double max)
{
...
// ---------------------------------------------------------
void BCMVCombination_EFT::AddUncertainty(std::string name)
{
...
// ---------------------------------------------------------
void BCMVCombination_EFT::AddMeasurement(std::string name, std::string observable, double value, std::vector<double> uncertainties)
{
   ...
   if (index < 0) {
      BCLog::OutWarning(Form("BCMVCombination_EFT::AddMeasurement. Observable \"%s\" does not exist. Measurement was not added.", observable.c_str()));
      return;
   }
...
// ---------------------------------------------------------
double BCMVCombination_EFT::LogLikelihood(const std::vector<double> &parameters)
{  
   //here: parameters=observables + nuisance_parameters
   double logprob = 0.;
...
// ---------------------------------------------------------
void BCMVCombination_EFT::PrepareAnalysis()
{
   int nuncertainties = GetNUncertainties();

   // prepare analysis
   for (int i = 0; i < nuncertainties; ++i){
      if(GetUncertainty(i)->GetFlagActive()==1){
   ...
   if (!PositiveDefinite()) {
      BCLog::OutWarning("BCMVCombination_EFT::PrepareAnalysis. Covariance matrix is not positive definite.");
   }
...
// ---------------------------------------------------------
int BCMVCombination_EFT::GetNActiveMeasurements()
{
   int n = GetNMeasurements();
...
// ---------------------------------------------------------
void BCMVCombination_EFT::CalculateHelperVectors()
{
   int nmeasurements  = GetNMeasurements();
...
// ---------------------------------------------------------
void BCMVCombination_EFT::CalculateCorrelationMatrix(int index)
{
...
// ---------------------------------------------------------
void BCMVCombination_EFT::CalculateCovarianceMatrix(std::vector<double> parameters) //parameters is here observables
{
...
// ---------------------------------------------------------
bool BCMVCombination_EFT::PositiveDefinite()
{
...
// ---------------------------------------------------------
void BCMVCombination_EFT::CalculateBLUE()
{
...
// ---------------------------------------------------------
void BCMVCombination_EFT::PrintBLUEResults(std::string filename)
{
   // open file
...
// ---------------------------------------------------------
void BCMVCombination_EFT::PrintMatrix(TMatrixD &matrix, std::string name)
{
...
// ---------------------------------------------------------
void BCMVCombination_EFT::PrintVector(TVectorD &vector, std::string name)
{
...
// ---------------------------------------------------------
int BCMVCombination_EFT::GetIndexMeasurement(std::string measurement, std::string observable)
{
...
// ---------------------------------------------------------
int BCMVCombination_EFT::GetIndexUncertainty(std::string name)
{
   int nuncertainties = GetNUncertainties();
...
// ---------------------------------------------------------
int BCMVCombination_EFT::GetIndexObservable(std::string name)
{
