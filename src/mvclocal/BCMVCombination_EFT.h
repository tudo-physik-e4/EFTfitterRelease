...
#ifndef __BCMVCOMBINATION_EFT__H
#define __BCMVCOMBINATION_EFT__H
...
// ---------------------------------------------------------
class BCMVCombination_EFT : public BCModel
{
 ...
 public:
  ...
  // Set the number of nuisance parameters
  void SetNNuisanceCorrelation(int n){
    fNNuisanceCorrelation=n;
  }
